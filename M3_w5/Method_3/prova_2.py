...
def create_Model():
    ...
    model.add(ZeroPadding2D(padding=(1, 1)))
    model.add(Conv2D(80, (5, 5), strides=(1, 1), padding='same', activation='relu'))
    model.add(MaxPooling2D((2, 2), strides=(2, 2)))
    ...
    myoptim = optimizers.Adam(lr=0.0001, beta_1=0.9, beta_2=0.999, epsilon=1e-08, decay=0.01)
...
if __name__ == "__main__":
    ...
    callback = EarlyStopping(monitor='val_acc', patience=11, verbose=1, mode='max')
